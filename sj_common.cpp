...
void GUI_GLOBAL::setup(string GuiName, string FileName, float x, float y)
{
	...
	********************/
	...
	Group_Logo.setup("Logo");
		...
		Group_Logo.add(Logo_ScaleSync_K.setup("ScaleSync_K", 200.0, 0.0, 500.0));
		Group_Logo.add(Logo_ScaleSync_Friction.setup("ScaleSync_Friction", 0.8, 0.0, 1.0));
		Group_Logo.add(b_Logo_ScaleSync.setup("ScaleSync", false));
		Group_Logo.add(b_Logo_ScaleSync_Dumping.setup("ScaleSync_Dumping", true));
	...
	Group_SpreadParticle.setup("SpreadParticle");
		...
		Group_SpreadParticle.add(SpreadParticle_Size_min.setup("Size_min", 4.0, 2.0, 50));
		Group_SpreadParticle.add(SpreadParticle_Size_max.setup("Size_max", 20.0, 2.0, 50));
		{
			ofColor initColor = ofColor(255, 255, 255, 255);
			ofColor minColor = ofColor(0, 0, 0, 0);
			ofColor maxColor = ofColor(255, 255, 255, 255);
